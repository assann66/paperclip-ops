        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-muted">
              We are an AI consultancy on a mission to make artificial
              intelligence practical and accessible for businesses of all sizes.
              Our team combines deep technical expertise with real-world business
              understanding to deliver solutions that create measurable impact.
            </p>
            <p className="mt-4 text-lg leading-8 text-muted" dir="rtl" lang="ar">
              نحن شركة استشارات ذكاء اصطناعي تهدف إلى جعل الذكاء الاصطناعي
              عمليًا ومتاحًا للشركات بمختلف أحجامها. نجمع بين الخبرة التقنية
              العميقة والفهم الواقعي للأعمال لتقديم حلول ذات تأثير قابل للقياس.
            </p>
            <div className="mt-10 grid grid-cols-2 gap-8">
              <div>
                <p className="text-3xl font-bold text-primary">AI-First</p>
                <p className="mt-1 text-sm text-muted">
                  Every solution built with AI at the core
                </p>
              </div>
              <div>
