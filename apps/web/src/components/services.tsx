const services = [
  {
    ...
    titleAr: 'حلول أعمال الذكاء الاصطناعي',
    description:
      'Custom AI-powered platforms and tools designed to automate workflows, extract insights, and drive better decision-making across your organization.',
  ...
  },
  {
    ...
    description:
      'Seamlessly connect your existing platforms and systems with intelligent APIs and automation pipelines that keep your business running smoothly.',
  ...
  },
  {
    ...
    description:
      'Expert guidance on AI strategy, implementation, and optimization. We help you identify the highest-impact opportunities and build a roadmap to get there.',
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted">
            End-to-end AI services from strategy to deployment
          </p>
        </div>
        <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            ...
            >
              ...
              <p className="mt-3 text-muted leading-7">{service.description}</p>
            </div>
          ))}
        </div>
      </div>
